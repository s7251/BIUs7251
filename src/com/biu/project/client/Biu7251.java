...
public class Biu7251 implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		greetingService.getAdress(new AsyncCallback<String>() {
		...
		greetingService.getCityAndPostalCode(new AsyncCallback<String>() {
			public void onFailure(Throwable caught) {
				System.out.println("fail");
			}
		...
		greetingService.getTelephone(new AsyncCallback<String>() {
			public void onFailure(Throwable caught) {
				System.out.println("fail");
			}
		...
		greetingService.getMail(new AsyncCallback<String>() {
			public void onFailure(Throwable caught) {
				System.out.println("fail");
			}
		...
		zapisz.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				greetingService.setAdress(street_edit2.getText(),
				...
				greetingService.setCityAndPostalCode(adress_edit2.getText(),
						new AsyncCallback<Void>() {
							public void onFailure(Throwable caught) {
								System.out.println("fail");
							}
				...
				greetingService.setTelephone(telephone_edit2.getText(),
						new AsyncCallback<Void>() {
							public void onFailure(Throwable caught) {
								System.out.println("fail");
							}
				...
				greetingService.setMail(mail_edit2.getText(),
						new AsyncCallback<Void>() {
							public void onFailure(Throwable caught) {
								System.out.println("fail");
							}
